...
class AnalyzerControllerTest {
    ...
    void generateSchema_AnalyzerServiceException_PropagatesException() {
        ...
        AnalyzerServiceException analyzerException = new AnalyzerServiceException(
                400, "http://localhost:8000/build_schema", "Not a sklearn estimator.",
    ...
    void generateSchema_AnalyzerServiceException_NetworkError() {
        // Given
        AnalyzerServiceException analyzerException = new AnalyzerServiceException(
                0, "http://localhost:8000/build_schema", "Analyzer service unreachable",
    ...
    void predict_Success() {
        ...
        verify(analyzerService).predict(eq(OAuthProvider.GITHUB), eq("github123"), eq(1L), eq(testPredictionData));
    }
    ...
    void predict_AnalyzerServiceException_UnprocessableEntity() {
        // Given
        AnalyzerServiceException analyzerException = new AnalyzerServiceException(
                422, "http://localhost:8000/predict", "Invalid input data format.",
    ...
    void predict_AnalyzerServiceException_NetworkError() {
        // Given
        AnalyzerServiceException analyzerException = new AnalyzerServiceException(
                0, "http://localhost:8000/predict", "Analyzer service unreachable",
                "Read timeout", null);
    ...
    void predict_IllegalArgumentException_ModelNotFound() {
        // Given
        when(analyzerService.predict(eq(OAuthProvider.GITHUB), eq("github123"), eq(999L), eq(testPredictionData)))
        ...
        verify(analyzerService).predict(eq(OAuthProvider.GITHUB), eq("github123"), eq(999L), eq(testPredictionData));
    }
    ...
    void predict_GoogleOAuthProvider() {
        ...
        verify(analyzerService).predict(eq(OAuthProvider.GOOGLE), eq("github123"), eq(1L), eq(testPredictionData));
    }
    ...
    void predict_SystemOAuthProvider() {
        ...
        verify(analyzerService).predict(eq(OAuthProvider.SYSTEM), eq("github123"), eq(1L), eq(testPredictionData));
    }
