...
class PredictionControllerTest {
    ...
    void updatePrediction_PredictionDoesNotExistsException() {
        ...
        assertTrue(
                thrownException.getMessage().contains("Prediction with ID '999' does not exist for user: github123"));
    ...
    void getAllPredictions_Success() {
        ...
        // When
        ResponseEntity<List<PredictionDto>> response = predictionController.getAllPredictions(mockAuthentication, 1L);
        ...
        verify(predictionService).getPredictionsBySignatureId(eq(OAuthProvider.GITHUB), eq("github123"), eq(1L));
    }
    ...
    void getAllPredictions_Success_EmptyList() {
        ...
        // When
        ResponseEntity<List<PredictionDto>> response = predictionController.getAllPredictions(mockAuthentication, 999L);
        ...
        verify(predictionService).getPredictionsBySignatureId(eq(OAuthProvider.GITHUB), eq("github123"), eq(999L));
    }
    ...
    void getAllPredictions_Success_SystemProvider() {
        ...
        verify(predictionService).getPredictionsBySignatureId(eq(OAuthProvider.SYSTEM), eq("system789"), eq(1L));
    }
    ...
    void handlePredictionAlreadyExistsException_ReturnsConflict() {
        ...
        // When
        ResponseEntity<ErrorDto> response = predictionController.handlePredictionAlreadyExistsException(exception,
                mockRequest);
    ...
    void handlePredictionDoesNotExistsException_ReturnsNotFound() {
        ...
        // When
        ResponseEntity<ErrorDto> response = predictionController.handlePredictionDoesNotExistsException(exception,
                mockRequest);
    ...
    void updatePrediction_AllStatusValues() {
        ...
        PredictionStatus[] statuses = { PredictionStatus.PENDING, PredictionStatus.COMPLETED, PredictionStatus.FAILED };
    ...
    void getAllPredictions_DifferentSignatureIds() {
        ...
        for (Long signatureId : signatureIds) {
            ...
            // When
            ResponseEntity<List<PredictionDto>> response = predictionController.getAllPredictions(mockAuthentication,
                    signatureId);
