...
export function ContrastControl() {
  ...
  return (
    <div className="grid gap-5 border-t border-line py-8 md:grid-cols-[minmax(0,1fr)_18rem] md:items-center">
      <div>
        <div className="flex items-center gap-2">
          <h3 className="text-base font-semibold text-fg">Contrast</h3>
          {contrast === 100 ? null : (
            <AppIconButton
      ...
      <div className="flex items-center gap-4">
        <output
          ...
          className="min-w-16 rounded-lg bg-surface-muted px-3 py-2 text-center font-mono text-xs font-semibold text-fg"
        >
          {contrast}%
        </output>
        <input
