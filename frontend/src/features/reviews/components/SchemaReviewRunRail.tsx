...
export function SchemaReviewRunRail({
  ...
  return (
    <aside className="flex flex-col rounded-card border border-line bg-surface p-5 lg:sticky lg:top-28 lg:h-[calc(100dvh-9rem-var(--app-nav-block,0rem))] lg:overflow-hidden">
