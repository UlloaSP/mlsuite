    ...
    <div className="auth-glass">
      ...
      <div className="flex items-center justify-between">
        <img
          ...
          width="1181"
        />
        <div className="auth-mono flex flex-col items-end gap-1 text-[10px] tracking-[0.25em]">
      ...
      >
        ...
        <span className="font-thin text-[var(--accent-primary)]">:</span>
        <span className="font-thin">{pad(now.getMinutes())}</span>
      </time>
      <h1 id="auth-title" className="text-[26px] tracking-[-0.03em]">
