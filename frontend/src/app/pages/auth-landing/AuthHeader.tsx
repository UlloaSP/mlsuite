...
export function AuthHeader() {
	...
	return (
		<header className="relative z-10 shrink-0">
			<div className="mb-2.5 flex items-center justify-between gap-4 px-5 pt-[18px] font-mono text-[9px] uppercase tracking-[0.08em] text-[#aaa] sm:px-7 sm:text-[10px] lg:px-[44px]">
