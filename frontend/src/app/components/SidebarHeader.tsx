...
export function SidebarHeader() {
  ...
  const content = (
    <SidebarSection collapsed={collapsed} className="p-4 border-b">
      <Link
        to="/profile"
        className={cx("block transition hover:bg-[var(--surface-soft)]/50", FOCUS_RING)}
        ...
        >
          ...
          {!collapsed && (
            ...
            >
              ...
              <p className="ml-2 mt-1 truncate text-xs font-medium uppercase tracking-[0.18em] text-[var(--text-muted)]">
