...
import { type JsonRecord, type PredictionPayloadField, getBackendKey, isRecord } from "./shared";
...
const toLegacyReportPayload = (report: ReportConfig, parsed: unknown): JsonRecord | undefined => {
