...
export function OrganizationSettingsPage() {
	...
	const ownerCandidates = members.filter((member) =>
		member.status === "ACTIVE" && member.role.systemKey !== "OWNER"
	);
				...
				<AppSurface className="flex flex-1 flex-col gap-6 overflow-auto">
					...
					{workspace?.permissions.canTransferOwnership ? (
						<AppPanel className="max-w-3xl">
							<div className="grid gap-4">
								<div>
									<p className="text-base font-semibold text-[var(--text-primary)]">Transfer ownership</p>
