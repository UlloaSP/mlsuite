...
export function CreateModelPage() {
    ...
    useEffect(() => {
        ...
        setName(nameWithoutExtension.replace(/[_-]/g, " ").replace(/\b\w/g, (l) => l.toUpperCase()))
    }, [selectedModelFile])
                ...
                <div className="flex flex-rows flex-1">
                    ...
                    >
                        ...
                        >
                            {steps.map(({ icon: Icon, label }, idx) => (
                                ...
                                >
                                    <span
                                        className="flex items-center justify-center w-12 h-12 rounded-full bg-slate-800/60 backdrop-blur ring-1 ring-inset ring-slate-700 shadow-inner"
                                    >
                                        <Icon size={22} />
                                    </span>
                        ...
                        >
                            ...
                            <ul className="list-disc list-inside text-xs text-slate-400 space-y-1">
                                ...
                                <li>Provide the final feature set in the optional dataframe.</li>
                            </ul>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="flex flex-col justify-between px-10">
                        <div>
                            ...
                            <UploadFile
                                acceptedFormats={[".joblib", ".pkl", ".pickle", ".h5", ".onnx", ".pt", ".pth"]}
                        ...
                        {/* Model Name Input */}
                        <div>
                            <label htmlFor="model-name" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                Nombre del Modelo
                            </label>
                            ...
                            {selectedModelFile && (
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                    Nombre auto-rellenado desde el archivo. Puedes modificarlo si lo deseas.
                                </p>
                            )}
                        </div>
