...
export function ModelListItem({ item, signatureCount, onOpen, onAction }: ModelListItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2">
        <ModelActionsMenu modelName={item.name} onAction={(action) => onAction(action, item)} />
