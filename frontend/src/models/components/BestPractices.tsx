...
export function BestPractices({ title, practices }: BestPracticesProps) {
	return (
		<motion.div className="justify-self-end p-4 rounded-2xl bg-slate-100/70 dark:bg-slate-800/50 backdrop-blur-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-700 shadow-md">
