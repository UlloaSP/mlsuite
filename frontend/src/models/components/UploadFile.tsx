        ...
        {selectedFile ? (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-[var(--success-text)]">{getFileSize(selectedFile.size)}</p>
            </div>
            <p className="text-xs text-[var(--text-secondary)]">{CHANGE_FILE_HINT}</p>
          </motion.div>
        ) : (
          <div className="space-y-3">
            ...
            <div>
              <p className="font-medium text-[var(--text-primary)]">{UPLOAD_FILE_HINT}</p>
