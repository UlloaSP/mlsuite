...
export function SelectItem({ children, className, value, ...props }: SelectItemProps) {
  return (
    <SelectPrimitive.Item
      className={cx(
        "relative flex w-full cursor-default select-none items-center rounded-control px-3 py-2.5 text-left text-sm outline-none transition data-[disabled]:pointer-events-none data-[highlighted]:bg-surface-muted data-[disabled]:opacity-45",
        className,
      )}
