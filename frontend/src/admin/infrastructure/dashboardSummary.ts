import type { InfrastructureOverviewDto, ServiceStatusDto } from "./types";
...
export function toneForMetric(value: number | null | undefined): "danger" | "warning" | "success" | "neutral" {
	if (value == null) {
		return "neutral";
	}
	if (value >= 85) {
