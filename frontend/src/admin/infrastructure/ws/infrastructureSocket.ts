...
export function openTerminalSocket(path: string, callbacks: SocketCallbacks<TerminalFrame>) {
...
function wireSocket<TMessage>(socket: WebSocket, callbacks: SocketCallbacks<TMessage>) {
