...
export function ProfileBody({ user }: ProfileBodyProps) {
    ...
    >
        <motion.div className="grid grid-cols-2 gap-6">
            ...
            <InfoCard icon={Languages} title="Culture" value={window.navigator.language || "Not provided"} />
            <InfoCard icon={Plane} title="Time Zone" value={Intl.DateTimeFormat().resolvedOptions().timeZone || "Not provided"} />
