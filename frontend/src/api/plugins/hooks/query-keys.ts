...
export const pluginCatalogPageQueryKey = (organizationId: number | string | undefined, page: number, type: TypeFilter, search: string, sort: SortMode) => [
  ...PLUGIN_CATALOG_PAGE_QUERY_KEY, organizationId ?? "none", page, PLUGIN_CATALOG_PAGE_SIZE, type, search, sort,
];
